...
<img src='http://i.imgur.com/QT3MO1U.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
We had not encountered SQL before, so it was a challenge to learn and implement a program which 
interacts with a database.

## License

    Copyright [2017] [Connor Frank, Gina Ratto]
